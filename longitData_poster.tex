...
\colorbox{LightSteelBlue}{\begin{minipage}[b]{0.35\linewidth}
        ...
        \Large
        Does tutoring in reading, provided by the BUILD program, to elementary school children in 		Berkeley public schools have a discernible effect on the reading exam scores of these children, as 	measured by the TWCRP?
        \vspace{2ex}
\end{minipage}}
\hfill
